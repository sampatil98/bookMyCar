...
let start1=localStorage.getItem("start_date");
let end1=localStorage.getItem("end_date");

let total=localStorage.getItem("totalPrice");
let amt=document.getElementById("span");
amt.innerText=total;

let billing_amt=document.getElementById("billing_amt");
billing_amt.innerText=total;
...
let car_name_billing=document.getElementById("car_Name");
car_name_billing.innerText=`${dataobj.name} ${dataobj.year}`;

let car_img_billing=document.getElementById("car_image");
car_img_billing.src=dataobj.image;

let start_date_billing=document.getElementById("start_time");
start_date_billing.innerText=start1;

let end_date_billing=document.getElementById("end_time");
end_date_billing.innerText=end1;
